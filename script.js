...
function _l(e, t) {
    ...
    if (o) {
        if (r) {
            if (t.queryHash !== yl(o, t.options))
                return !1
        } else if (!xl(t.queryKey, o))
            return !1
    }
    if (n !== `all`) {
        let e = t.isActive();
...
function vl(e, t) {
    ...
    if (a) {
        if (!t.options.mutationKey)
            return !1;
        if (n) {
            if (bl(t.options.mutationKey) !== bl(a))
                return !1
        } else if (!xl(t.options.mutationKey, a))
            return !1
    }
...
function bl(e) {
    return JSON.stringify(e, (e, t) => Tl(t) ? Object.keys(t).sort().reduce( (e, n) => (e[n] = t[n],
    e), {}) : t)
}
function xl(e, t) {
...
;
function q(e) {
    let t = !1, n = 0, r, i = Fl(), a = () => i.status !== `pending`, o = t => {
        if (!a()) {
            let n = new K(t);
            f(n),
            e.onCancel?.(n)
    ...
    , l = () => sl.isFocused() && (e.networkMode === `always` || zl.isOnline()) && e.canRun(), u = () => G(e.networkMode) && e.canRun(), d = e => {
        a() || (r?.(),
        i.resolve(e))
    }
    , f = e => {
...
var J = class {
    ...
    scheduleGc() {
        this.clearGcTimeout(),
        pl(this.gcTime) && (this.#e = ll.setTimeout( () => {
            this.optionalRemove()
        }
        , this.gcTime))
    }
    ...
    clearGcTimeout() {
        this.#e !== void 0 && (ll.clearTimeout(this.#e),
        this.#e = void 0)
    }
}
;
...
var Ul = class extends J {
    ...
    setOptions(e) {
        ...
        this.state && this.state.data === void 0) {
            ...
            e.data !== void 0 && (this.setState(Gl(e.data, e.dataUpdatedAt)),
            this.#t = e)
        }
    }
    optionalRemove() {
    ...
    cancel(e) {
        ...
        t ? t.then(dl).catch(dl) : Promise.resolve()
    }
    destroy() {
        super.destroy(),
        this.cancel({
    ...
    async fetch(e, t) {
        ...
        (this.#e === `infinite` ? Y(this.options.pages) : this.options.behavior)?.onFetch(a, this),
        this.#n = this.state,
        ...
        this.#a = q({
            ...
            fn: a.fetchFn,
            onCancel: e => {
                e instanceof K && e.revert && this.setState({
                    ...this.#n,
                    fetchStatus: `idle`
                }),
                n.abort()
...
var Xl = class extends ol {
  ...
  , Zl = class {
    ...
    mount() {
        this.#a++,
        this.#a === 1 && (this.#o = sl.subscribe(async e => {
    ...
    ensureQueryData(e) {
        let t = this.defaultQueryOptions(e)
          ...
          , r = n.state.data;
        return r === void 0 ? this.fetchQuery(e) : (e.revalidateIfStale && n.isStaleByTime(hl(t.staleTime, n)) && this.prefetchQuery(t),
        Promise.resolve(r))
    }
    getQueriesData(e) {
    ...
    setQueriesData(e, t, n) {
        return Rl.batch( () => this.#e.findAll(e).map( ({queryKey: e}) => [e, this.setQueryData(e, t, n)]))
    }
    getQueryState(e) {
        let t = this.defaultQueryOptions({
            queryKey: e
    ...
    refetchQueries(e, t={}) {
        let n = {
          ...
          , r = Rl.batch( () => this.#e.findAll(e).filter(e => !e.isDisabled() && !e.isStatic()).map(e => {
            ...
            return n.throwOnError || (t = t.catch(dl)),
    ...
    defaultQueryOptions(e) {
        ...
        return t.queryHash ||= yl(t.queryKey, t),
  ...
  , $l = ({client: e, children: t}) => (z.useEffect( () => (e.mount(),
() => {
    e.unmount()
}
), [e]),
...
var iu = wc()({
    head: () => ({
        meta: [{
            ...
            title: `CodeBuddy — Breaking Down Barriers to Software Development`
        }, {
            name: `description`,
            content: `You bring the ideas and business expertise. CodeBuddy gives you the canvas, tools, and engineers to build custom software — faster, cheaper, and more reliable.`
        }, {
            name: `author`,
            content: `CodeBuddy`
        }, {
            property: `og:title`,
            content: `CodeBuddy — Breaking Down Barriers to Software Development`
        }, {
            property: `og:description`,
            content: `Build the custom software your business needs — dashboards, workflows, mobile apps, AI, automation. CodeBuddy Studio or a full engineering team.`
        }, {
            property: `og:type`,
            content: `website`
        }, {
...
function ou() {
    let {queryClient: e} = iu.useRouteContext();
    return (0,
    B.jsx)($l, {
        client: e,
        children: (0,
...
var su = `modulepreload`
  ...
  , du = {
    IndexRoute: Dc(`/`)({
        component: kc( () => uu( () => import(`./routes-BBCW5bVL.js`), []), `component`)
    }).update({
        id: `/`,
        path: `/`,
        getParentRoute: () => iu
